package com.asav.facematcher.mtcnn
...
class MTCNN(val tensorFlowInferenceInterface: TensorFlowInferenceInterface)  {
    companion object {
        fun create (assetManager : AssetManager) : MTCNN {
            return MTCNN(TensorFlowInferenceInterface(assetManager, "file:///android_asset/mtcnn_model.pb"))
        }
    }
